...
//session_unset();
$auth_data = isset($_SESSION['casdoor_authenticated']) ? $_SESSION['casdoor_authenticated'] : null;
$user_data = isset($_SESSION['casdoor_user']) ? $_SESSION['casdoor_user'] : null;
...
if ($auth_data !== null) {
    $_SESSION['casdoor_authenticated'] = $auth_data;
}
if ($user_data !== null) {
    $_SESSION['casdoor_user'] = $user_data;
}
?>
